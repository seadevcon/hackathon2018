...
We use slack to coordinate the event and distribute the access token for the API's above. You can join our slack channel at [seadevcon.slack.com](http://seadevcon.slack.com). If you need an invite, send an email [here](garreau@maritimedatasystem) with subject line "Slack Hackathon".
